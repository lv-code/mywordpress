...
$post_options = array(
		...
		'hide_meta'	 	=> array(
			'id' 			=> 'hide_meta',
			'title' 		=> __( 'Check to hide post meta on this post', 'newsplus' ),
			'type' 			=> 'checkbox'
		),
		
		'hide_image'	 	=> array(
			'id' 			=> 'hide_image',
			'title' 		=> __( 'Check to hide featured image on this post', 'newsplus' ),
			'type' 			=> 'checkbox'
		),
        ...
        foreach ( $post_options as $meta_box ) {
			...
			elseif ( $meta_box['type'] == 'checkbox' ) { ?>
                <div>
                    ...
                    <label for="<?php echo $meta_box['id']; ?>"><input type="checkbox" name="<?php echo $meta_box['id']; ?>" id="<?php echo $meta_box['id']; ?>" value="true" <?php echo $checked; ?> /><?php echo $meta_box['title']; ?></label>
                    <p><?php if ( isset( $meta_box['description'] ) ) echo $meta_box['description']; ?></p>
                </div>
			<?php }
