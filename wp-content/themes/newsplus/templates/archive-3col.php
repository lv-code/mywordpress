 ...
 *
 * Description: A three columnar grid archive template.
 */
            ...
            while ( $wp_query->have_posts() ) :
				...
				<div class="entry-content">
                    ...
                    <p class="post-excerpt">
                        <?php if ( 'true' == $pls_use_word_length ) {
                            echo short_by_word( get_the_excerpt(), $pls_word_length );
                        }
                        else {
                            echo short( get_the_excerpt(), 160 );
                        } ?>
                    </p>
