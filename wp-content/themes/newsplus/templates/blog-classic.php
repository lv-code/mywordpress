    ...
    if ( $category ) :
		...
		if ( $wp_query->have_posts() ) :
			while ( $wp_query->have_posts() ) :
				$wp_query->the_post(); ?>
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'entry entry-classic clear' ); ?>>
                    ...
                    <p><a class="more-link" href="<?php the_permalink(); ?>" title="<?php _e( 'Read full post', 'newsplus'); ?>"><?php _e( 'Read more', 'newsplus' ); ?></a></p>
