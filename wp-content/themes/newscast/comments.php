...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments"><?php _e("This post is password protected. Enter the password to view comments.",'newscast'); ?></p>
	<?php
		return;
	}
...
<?php if ( have_comments() ) : ?><!--you need the id comments for the links to the comments-->
	<h4 class="heading" id="comments"><?php comments_number(__('No Responses','newscast'), __('One Response','newscast'), __('% Responses','newscast') );?> to &#8220;<?php the_title(); ?>&#8221;</h4>
...
<div class="comment_nav">
	<?php previous_comments_link("<span class='comment_prev advancedlink'>&laquo; ".__('Older Comments','newscast')."</span>") ?>
	<?php next_comments_link("<span class='comment_next advancedlink'>".__('Newer Comments','newscast')." &raquo;</span>") ?>
</div>
...
<span class="meta" id="comments"><?php comments_number(__('No Responses','newscast'), __('One Response','newscast'), __('% Responses','newscast') );?> 
<?php _e('to','newscast'); ?> &#8220;<?php the_title(); ?>&#8221;</span>    
	 <?php else : // comments are closed ?>
		<!-- If comments are closed. -->
		<span class="meta"><?php _e('Comments are closed.','newscast'); ?></span>
...
<p>
<?php _e('You must be','mewscast'); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>">
<?php _e('logged in','newscast'); ?>
</a> 
<?php _e('to post a comment.','newscast'); ?>
</p>
