				...
				<div class="row">
					<div class="col-md-8 <?php echo esc_attr( $push_content ); ?>">
						...
						<header class="ptbar-content clearfix">
							<span class="sub-title"><?php esc_html_e( 'Archives', 'color-theme-framework' ); ?><?php echo esc_html('&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;') . esc_html( $count_posts ) . '&nbsp;' . esc_html__('articles found', 'color-theme-framework'); ?></span>
							<h1 class="entry-title"><?php printf( esc_html__( '%s', 'color-theme-framework' ), '<span class="vcard">Author:&nbsp;' . get_the_author() . '</span>' ); ?></h1>
