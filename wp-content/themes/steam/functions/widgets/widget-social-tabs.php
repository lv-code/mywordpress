...
class it_social_tabs extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if($twitter && ($order=='twitter' || empty($order))) {
			$twitter_shown=true;
			echo '<li><a href="#twitter-social-tab" class="info icon-twitter" title="' . __('Twitter', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		}		
		if($pinterest && $order=='pinterest') {
			$pinterest_shown=true;
			echo '<li><a href="#pinterest-social-tab" class="info icon-pinterest" title="' . __('Pinterest', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		}
		if($facebook && $order=='facebook') {
			$facebook_shown=true;
			echo '<li><a href="#facebook-social-tab" class="info icon-facebook" title="' . __('Facebook', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		}		
		if($flickr && $order=='flickr') {
			$flickr_shown=true;
			echo '<li><a href="#flickr-social-tab" class="info icon-flickr" title="' . __('Flickr', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		}
		if($comments && $order=='comments') {
			$comments_shown=true;
			echo '<li><a href="#comments-social-tab" class="info icon-commented" title="' . __('Recent Comments', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		}
		if($twitter && !$twitter_shown) echo '<li><a href="#twitter-social-tab" class="info active icon-twitter" title="' . __('Twitter', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		if($pinterest && !$pinterest_shown) echo '<li><a href="#pinterest-social-tab" class="info icon-pinterest" title="' . __('Pinterest', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		if($facebook && !$facebook_shown) echo '<li><a href="#facebook-social-tab" class="info icon-facebook" title="' . __('Facebook', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		
		if($flickr && !$flickr_shown) echo '<li><a href="#flickr-social-tab" class="info icon-flickr" title="' . __('Flickr', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		if($comments && !$comments_shown) echo '<li><a href="#comments-social-tab" class="info icon-commented" title="' . __('Recent Comments', IT_TEXTDOMAIN) . '"><span class="selector-arrow"></span></a></li>';
		echo '</ul>';		
	...
	function form( $instance ) {
        ...
        <p>
			...
			<label for="<?php echo $this->get_field_id( 'twitter' ); ?>"><?php _e( 'Display Latest Tweets', IT_TEXTDOMAIN); ?></label>&nbsp;->&nbsp;
