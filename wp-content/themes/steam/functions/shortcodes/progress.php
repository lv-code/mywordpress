...
class itProgress {
	...
	public static function progress( $atts = null, $content = null ) {
				...
				'options' => array(
					...
					array(
						...
						'options' => array(
							...
							'progress-info' => __('Info', IT_TEXTDOMAIN ),
							'progress-success' => __('Success', IT_TEXTDOMAIN ),
							'progress-warning' => __('Warning', IT_TEXTDOMAIN ),
							'progress-danger' => __('Danger', IT_TEXTDOMAIN ),
						),
						'type' => 'select',
						'target' => '',
					),
		...
		$out = '<div class="progress '.$variation.' '.$striped.' '.$animated.'"><div class="bar" style="width: '.$size.'%;"></div></div>';
