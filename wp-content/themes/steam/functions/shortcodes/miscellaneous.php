...
class itMiscellaneous {
	...
	public static function divider_top( $atts = null, $content = null, $code = null ) {
		...
		return '<div class="divider top"><a href="#top"><span class="icon-up-bold"></span>' . __( 'Top', IT_TEXTDOMAIN ) . '</a></div>';
	}
	...
	public static function div( $atts = null, $content = null, $code = null ) {
	   ...
	   return '<div class="' . $class . '" style="' . $style . '">' . it_remove_wpautop( $content ) . '</div>';
	}
	...
	public static function span( $atts = null, $content = null, $code = null ) {
	   ...
	   return '<span class="' . $class . '" style="' . $style . '">' . it_remove_wpautop( $content ) . '</span>';
	}
	...
	public static function hidden( $atts = null, $content = null ) {
		...
		return '<div class="hidden">' . it_remove_wpautop( $content ) . '</div>';
	}
