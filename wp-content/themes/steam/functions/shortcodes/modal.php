...
class itModal {
	...
	public static function modal( $atts = null, $content = null ) {
		...
		$out .= '<div id="'.$id.'" class="modal hide fade" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-header">'.$dismiss_header.' '.$heading.'</div>'.$content.'<div class="modal-footer">'.do_shortcode($footer).' '.$dismiss_footer.'</div></div>';
