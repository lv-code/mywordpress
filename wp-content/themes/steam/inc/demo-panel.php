<div class="demo-wrapper">
    ...
    <div class="demo">
        ...
        <div class="content">
        	...
        	<div class="header"><?php _e('DEMO SETTINGS',IT_TEXTDOMAIN); ?></div>
            
            <div class="text-label"><?php _e('Accents',IT_TEXTDOMAIN); ?></div>
            
            <input type="text" class="wp-color-picker accent-color" value="#BD2A33" data-default-color="#BD2A33" />
           
            <div class="text-label"><?php _e('Background',IT_TEXTDOMAIN); ?></div>
            
            <input type="text" class="wp-color-picker background-color" value="#FFFFFF" data-default-color="#FFFFFF" /> 
            
          	<div class="divider">&nbsp;</div> 
            
            <div class="text-label"><?php _e('Google Fonts',IT_TEXTDOMAIN); ?></div>
            
            <select name="menu-fonts" id="menu-fonts" class="input-small">
            	<option><?php _e('MENU FONT...',IT_TEXTDOMAIN); ?></option>
            	<?php $fonts = it_demo_fonts();
				foreach($fonts as $key => $value) {
					$key = str_replace(' ', '+', str_replace('"', '', str_replace(', sans-serif', '', $key)));
					echo '<option value="'.$key.'">'.$value.'</option>';
				} ?>                   
            </select>
            
            <select name="section-header-fonts" id="section-header-fonts" class="input-small">
            	<option><?php _e('SECTION HEADERS...',IT_TEXTDOMAIN); ?></option>
            	<?php $fonts = it_demo_fonts();
				foreach($fonts as $key => $value) {
					$key = str_replace(' ', '+', str_replace('"', '', str_replace(', sans-serif', '', $key)));
					echo '<option value="'.$key.'">'.$value.'</option>';
            ...
            <select name="content-header-fonts" id="content-header-fonts" class="input-small">
            	<option><?php _e('CONTENT HEADERS...',IT_TEXTDOMAIN); ?></option>
            	<?php $fonts = it_demo_fonts();
				foreach($fonts as $key => $value) {
					$key = str_replace(' ', '+', str_replace('"', '', str_replace(', sans-serif', '', $key)));
					echo '<option value="'.$key.'">'.$value.'</option>';
            ...
            <select name="body-fonts" id="body-fonts" class="input-small">
            	<option><?php _e('BODY FONT...',IT_TEXTDOMAIN); ?></option>
            	<?php $fonts = it_demo_fonts();
				foreach($fonts as $key => $value) {
					$key = str_replace(' ', '+', str_replace('"', '', str_replace(', sans-serif', '', $key)));
					echo '<option value="'.$key.'">'.$value.'</option>';
            ...
            <select name="widget-fonts" id="widget-fonts" class="input-small">
            	<option><?php _e('WIDGET FONT...',IT_TEXTDOMAIN); ?></option>
            	<?php $fonts = it_demo_fonts();
				foreach($fonts as $key => $value) {
					$key = str_replace(' ', '+', str_replace('"', '', str_replace(', sans-serif', '', $key)));
					echo '<option value="'.$key.'">'.$value.'</option>';
            ...
            <a href="http://www.industrialthemes.com/steam/support/" class="btn btn-inverse btn-small more-options"><?php _e('More Theme Info',IT_TEXTDOMAIN); ?><span class="icon-right-thin"></span></a>                
            
        </div>
    
    </div>
    
    <div class="toggle-demo info" title="Show demo settings panel" data-placement="right"><a class="icon-cog"></a></div>
    <div class="toggle-demo hide-demo info" title="Hide demo settings panel" data-placement="right"><a class="icon-cog"></a></div>
    
</div>

<?php 
function it_demo_fonts() {
	$fonts = array(
