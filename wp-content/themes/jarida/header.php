...
if (is_home() || is_page()) {
    ...
    $description = "这里有各种故事，故事花园有很多丰富的故事等着你发现，赶快开始你的故事之旅吧！";
    // 将以下引号中的内容改成你的主页keywords
    $keywords = "故事,名人故事,古文典籍,寓言故事,成语故事,美食故事,丰富的故事等着你发现";
} elseif (is_single()) {
...
?>
<meta name="keywords" content="<?php echo preg_replace('/\s/','',$keywords); ?>"/>
<meta name="description" content="<?php echo preg_replace('/\s/','',tie_content_limit($description , 100 )); ?>"/>
<?php wp_head(); ?>
</head>
<?php global $is_IE ?>
