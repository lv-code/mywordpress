...
<div class="mo-panel">
	...
	<?php if( get_option( 'tie_theme_save' ) == 'n') : ?>
	<form method="post">
	<?php else: ?>
	...
	<?php endif; ?>
				...
				<div class="option-item">
					...
					<ul id="tie_theme_layout" class="tie-options">
						<li>
							...
							<a class="checkbox-select" href="#"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/boxed.png" /></a>
						</li>
						<li>
							<input id="tie_theme_layout" name="tie_options[theme_layout]" type="radio" value="full" <?php if($tie_theme_layout == 'full') echo $checked; ?> />
							<a class="checkbox-select" href="#"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/full.png" /></a>
						</li>
					</ul>
				</div>
				...
				<div class="option-item">
					...
					tie_options(
						array(	"name" => "Number of Columns",
								"id" => "columns_num",
								"type" => "radio",
								"options" => array( "3c"=>"Three Columns" ,
													"2c"=>"Two Columns" )));
					?>
			...
			<div class="tiepanel-item"  style=" overflow: visible; ">
							...
							if($cats){
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											<label><span>Box Category : </span><select name="tie_home_cats1[<?php echo $i ?>][id]" id="tie_home_cats1[<?php echo $i ?>][id]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											<label><span>Posts Order : </span><select name="tie_home_cats1[<?php echo $i ?>][order]" id="tie_home_cats1[<?php echo $i ?>][order]"><option value="latest" <?php if( $cat['order'] == 'latest' || $cat['order']=='' ) echo 'selected="selected"'; ?>>Latest Posts</option><option  <?php if( $cat['order'] == 'rand' ) echo 'selected="selected"'; ?> value="rand">Random Posts</option></select></label>
											<label for="tie_home_cats1[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][number]" name="tie_home_cats1[<?php echo $i ?>][number]" value="<?php if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats1[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][offset]" name="tie_home_cats1[<?php echo $i ?>][offset]" value="<?php if( !empty($cat['offset']) ) echo $cat['offset']  ?>" type="text" /></label>
											
											<label>
												<span style="float:left; width:162px">Box Style : </span>
												<ul class="tie-cats-options tie-options">
													<li>
														<input id="tie_home_cats1[<?php echo $i ?>][style]" name="tie_home_cats1[<?php echo $i ?>][style]" type="radio" value="li" <?php if( $cat['style'] == 'li' || $cat['style']=='' ) echo 'checked="checked"'; ?> />
														<a class="checkbox-select" href="#"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/li.png" /></a>
													</li>
													<li>
														<input id="tie_home_cats1[<?php echo $i ?>][style]" name="tie_home_cats1[<?php echo $i ?>][style]" type="radio" value="2c" <?php if( $cat['style'] == '2c' ) echo 'checked="checked"' ?> />
														<a class="checkbox-select" href="#"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/2c.png" /></a>
													</li>
													<li>
														<input id="tie_home_cats1[<?php echo $i ?>][style]" name="tie_home_cats1[<?php echo $i ?>][style]" type="radio" value="1c" <?php if( $cat['style'] == '1c') echo 'checked="checked"' ?> />
								...
								<?php 
									elseif( $cat['type'] == 'recent' ) :	?>
										...
										<div class="widget-content">
											<label><span style="float:left;">Exclude Categories : </span><select multiple="multiple" name="tie_home_cats1[<?php echo $i ?>][exclude][]" id="tie_home_cats1[<?php echo $i ?>][exclude][]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( @in_array( $key , $cat['exclude'] ) ) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											<label for="tie_home_cats1[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats1[<?php echo $i ?>][title]" name="tie_home_cats1[<?php echo $i ?>][title]" value="<?php if( !empty($cat['title']) ) echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats1[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][number]" name="tie_home_cats1[<?php echo $i ?>][number]" value="<?php if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats1[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats1[<?php echo $i ?>][offset]" name="tie_home_cats1[<?php echo $i ?>][offset]" value="<?php if( !empty($cat['offset']) ) echo $cat['offset']  ?>" type="text" /></label>

											<label for="tie_home_cats1[<?php echo $i ?>][display]"><span>Display Mode:</span>
												<select id="tie_home_cats1[<?php echo $i ?>][display]" name="tie_home_cats1[<?php echo $i ?>][display]">
											...
											<label for="tie_home_cats1[<?php echo $i ?>][pagi]"><span>Show Pagination:</span>
												<select id="tie_home_cats1[<?php echo $i ?>][pagi]" name="tie_home_cats1[<?php echo $i ?>][pagi]">
											...
											<input id="tie_home_cats1[<?php echo $i ?>][boxid]" name="tie_home_cats1[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
									...
									<?php elseif( $cat['type'] == 'ads' ) : ?>
										...
										<div class="widget-content">
											<textarea cols="36" rows="5" name="tie_home_cats1[<?php echo $i ?>][text]" id="tie_home_cats1[<?php echo $i ?>][text]"><?php if( !empty($cat['text']) ) echo stripslashes($cat['text']) ; ?></textarea>
											<input id="tie_home_cats1[<?php echo $i ?>][boxid]" name="tie_home_cats1[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
									...
									<?php elseif( $cat['type'] == 'divider' ) : ?>
										...
										<div class="widget-content">
											<label for="tie_home_cats1[<?php echo $i ?>][height]"><span>Height :</span><input id="tie_home_cats1[<?php echo $i ?>][height]" name="tie_home_cats1[<?php echo $i ?>][height]" value="<?php if( !empty($cat['height']) ) echo $cat['height']  ?>" type="text" style="width:50px;" /> px</label>

									<?php endif; ?>
									
									
											<input id="tie_home_cats1[<?php echo $i ?>][type]" name="tie_home_cats1[<?php echo $i ?>][type]" value="<?php  echo $cat['type']  ?>" type="hidden" />
											<a class="del-cat"></a>
							...
							if($cats){
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											<label><span>Box Category : </span><select name="tie_home_cats2[<?php echo $i ?>][id]" id="tie_home_cats2[<?php echo $i ?>][id]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											<label><span>Posts Order : </span><select name="tie_home_cats2[<?php echo $i ?>][order]" id="tie_home_cats2[<?php echo $i ?>][order]"><option value="latest" <?php if( $cat['order'] == 'latest' || $cat['order']=='' ) echo 'selected="selected"'; ?>>Latest Posts</option><option  <?php if( $cat['order'] == 'rand' ) echo 'selected="selected"'; ?> value="rand">Random Posts</option></select></label>
											<label for="tie_home_cats2[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][number]" name="tie_home_cats2[<?php echo $i ?>][number]" value="<?php  if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][offset]" name="tie_home_cats2[<?php echo $i ?>][offset]" value="<?php  if( !empty($cat['offset']) ) echo $cat['offset']  ?>" type="text" /></label>
									...
									<?php elseif( $cat['type'] == 's' ) : ?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats2[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats2[<?php echo $i ?>][title]" name="tie_home_cats2[<?php echo $i ?>][title]" value="<?php  if( !empty($cat['title']) ) echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][number]" name="tie_home_cats2[<?php echo $i ?>][number]" value="<?php  if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats2[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][offset]" name="tie_home_cats2[<?php echo $i ?>][offset]" value="<?php  if( !empty($cat['offset']) ) echo $cat['offset']  ?>" type="text" /></label>

											<input id="tie_home_cats2[<?php echo $i ?>][boxid]" name="tie_home_cats2[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
								...
								<?php
									elseif( $cat['type'] == 'rev' ) :	?>
										...
										<div class="widget-content">
											<label for="tie_home_cats2[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats2[<?php echo $i ?>][title]" name="tie_home_cats2[<?php echo $i ?>][title]" value="<?php   if( !empty($cat['title']) ) echo $cat['title']  ?>" type="text" /></label>
											<label><span>Box Category 1 : </span><select name="tie_home_cats2[<?php echo $i ?>][id1]" id="tie_home_cats2[<?php echo $i ?>][id1]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id1']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>

											<label><span>Box Category 2 : </span><select name="tie_home_cats2[<?php echo $i ?>][id2]" id="tie_home_cats2[<?php echo $i ?>][id2]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id2']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											
											<label><span>Box Category 3 : </span><select name="tie_home_cats2[<?php echo $i ?>][id3]" id="tie_home_cats2[<?php echo $i ?>][id3]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id3']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											<label><span>Posts Order : </span><select name="tie_home_cats2[<?php echo $i ?>][order]" id="tie_home_cats2[<?php echo $i ?>][order]"><option value="latest" <?php if( $cat['order'] == 'latest' || $cat['order']=='' ) echo 'selected="selected"'; ?>>Latest Reviews</option><option  <?php if( $cat['order'] == 'rand' ) echo 'selected="selected"'; ?> value="rand">Random Reviews</option><option  <?php if( $cat['order'] == 'best' ) echo 'selected="selected"'; ?> value="best">Best Reviews</option></select></label>
											<label for="tie_home_cats2[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats2[<?php echo $i ?>][number]" name="tie_home_cats2[<?php echo $i ?>][number]" value="<?php if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
									...
									<?php elseif( $cat['type'] == 'ads' ) : ?>
										...
										<div class="widget-content">
											<textarea cols="36" rows="5" name="tie_home_cats2[<?php echo $i ?>][text]" id="tie_home_cats2[<?php echo $i ?>][text]"><?php if( !empty($cat['text']) ) echo stripslashes($cat['text']) ; ?></textarea>
											<input id="tie_home_cats2[<?php echo $i ?>][boxid]" name="tie_home_cats2[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
											<small>Supports <strong>Text, HTML and Shortcodes</strong> .</small>
									...
									<?php endif; ?>
											...
											<input id="tie_home_cats2[<?php echo $i ?>][type]" name="tie_home_cats2[<?php echo $i ?>][type]" value="<?php  echo $cat['type']  ?>" type="hidden" />
											<a class="del-cat"></a>
							...
							if($cats){
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											<label><span>Box Category : </span><select name="tie_home_cats3[<?php echo $i ?>][id]" id="tie_home_cats3[<?php echo $i ?>][id]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											<label><span>Posts Order : </span><select name="tie_home_cats3[<?php echo $i ?>][order]" id="tie_home_cats3[<?php echo $i ?>][order]"><option value="latest" <?php if( $cat['order'] == 'latest' || $cat['order']=='' ) echo 'selected="selected"'; ?>>Latest Posts</option><option  <?php if( $cat['order'] == 'rand' ) echo 'selected="selected"'; ?> value="rand">Random Posts</option></select></label>
											<label for="tie_home_cats3[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][number]" name="tie_home_cats3[<?php echo $i ?>][number]" value="<?php  if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats3[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][offset]" name="tie_home_cats3[<?php echo $i ?>][offset]" value="<?php  if( !empty($cat['offset']) ) echo $cat['offset']  ?>" type="text" /></label>
																						
											<label>
												<span style="float:left; width:162px">Box Style : </span>
												<ul class="tie-cats-options tie-options">
													<li>
														<input id="tie_home_cats3[<?php echo $i ?>][style]" name="tie_home_cats3[<?php echo $i ?>][style]" type="radio" value="li" <?php if( $cat['style'] == 'li' || $cat['style']=='' ) echo 'checked="checked"'; ?> />
														<a class="checkbox-select" href="#"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/li.png" /></a>
													</li>
													<li>
														<input id="tie_home_cats3[<?php echo $i ?>][style]" name="tie_home_cats3[<?php echo $i ?>][style]" type="radio" value="2c" <?php if( $cat['style'] == '2c' ) echo 'checked="checked"' ?> />
														<a class="checkbox-select" href="#"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/2c.png" /></a>
													</li>
													<li>
														<input id="tie_home_cats3[<?php echo $i ?>][style]" name="tie_home_cats3[<?php echo $i ?>][style]" type="radio" value="1c" <?php if( $cat['style'] == '1c') echo 'checked="checked"' ?> />
														<a class="checkbox-select" href="#"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/1c.png" /></a>
													</li>
												</ul>
											</label>
								<?php 
									elseif( $cat['type'] == 'recent' ) :	?>
										...
										<div class="widget-content">
											<label><span style="float:left;">Exclude This Categories : </span><select multiple="multiple" name="tie_home_cats3[<?php echo $i ?>][exclude][]" id="tie_home_cats3[<?php echo $i ?>][exclude][]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( @in_array( $key , $cat['exclude'] ) ) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											<label for="tie_home_cats3[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats3[<?php echo $i ?>][title]" name="tie_home_cats3[<?php echo $i ?>][title]" value="<?php   if( !empty($cat['title']) )  echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats3[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][number]" name="tie_home_cats3[<?php echo $i ?>][number]" value="<?php   if( !empty($cat['number']) )  echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats3[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats3[<?php echo $i ?>][offset]" name="tie_home_cats3[<?php echo $i ?>][offset]" value="<?php  if( !empty($cat['offset']) )   echo $cat['offset']  ?>" type="text" /></label>

											<label for="tie_home_cats3[<?php echo $i ?>][display]"><span>Display Mode:</span>
												<select id="tie_home_cats3[<?php echo $i ?>][display]" name="tie_home_cats3[<?php echo $i ?>][display]">
													<option value="default" <?php if ( $cat['display'] == 'default') { echo ' selected="selected"' ; } ?>>Default Style</option>
													<option value="blog" <?php if ( $cat['display'] == 'blog') { echo ' selected="selected"' ; } ?>>Blog Style</option>
												</select>
											</label>
											<label for="tie_home_cats3[<?php echo $i ?>][pagi]"><span>Show Pagination:</span>
												<select id="tie_home_cats3[<?php echo $i ?>][pagi]" name="tie_home_cats3[<?php echo $i ?>][pagi]">
													<option value="n" <?php if ( $cat['pagi'] == 'n') { echo ' selected="selected"' ; } ?>>No</option>
													<option value="y" <?php if ( $cat['pagi'] == 'y') { echo ' selected="selected"' ; } ?>>Yes</option>
												</select>
											</label>
											...
											<input id="tie_home_cats3[<?php echo $i ?>][boxid]" name="tie_home_cats3[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
									...
									<?php elseif( $cat['type'] == 'ads' ) : ?>
										...
										<div class="widget-content">
											<textarea cols="36" rows="5" name="tie_home_cats3[<?php echo $i ?>][text]" id="tie_home_cats3[<?php echo $i ?>][text]"><?php if( !empty($cat['text']) ) echo stripslashes($cat['text']) ; ?></textarea>
											<input id="tie_home_cats3[<?php echo $i ?>][boxid]" name="tie_home_cats3[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
											<small>Supports <strong>Text, HTML and Shortcodes</strong> .</small>
									...
									<?php elseif( $cat['type'] == 'divider' ) : ?>
										...
										<div class="widget-content">
											<label for="tie_home_cats3[<?php echo $i ?>][height]"><span>Height :</span><input id="tie_home_cats3[<?php echo $i ?>][height]" name="tie_home_cats3[<?php echo $i ?>][height]" value="<?php  if( !empty($cat['height']) ) echo $cat['height']  ?>" type="text" style="width:50px;" /> px</label>

									<?php endif; ?>
									
									
											<input id="tie_home_cats3[<?php echo $i ?>][type]" name="tie_home_cats3[<?php echo $i ?>][type]" value="<?php  echo $cat['type']  ?>" type="hidden" />
											<a class="del-cat"></a>
							...
							if($cats){
								...
								<?php 
									if( $cat['type'] == 'n' ) :	?>
										...
										<div class="widget-content">
											<label><span>Box Category : </span><select name="tie_home_cats4[<?php echo $i ?>][id]" id="tie_home_cats4[<?php echo $i ?>][id]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											<label><span>Posts Order : </span><select name="tie_home_cats4[<?php echo $i ?>][order]" id="tie_home_cats4[<?php echo $i ?>][order]"><option value="latest" <?php if( $cat['order'] == 'latest' || $cat['order']=='' ) echo 'selected="selected"'; ?>>Latest Posts</option><option  <?php if( $cat['order'] == 'rand' ) echo 'selected="selected"'; ?> value="rand">Random Posts</option></select></label>
											<label for="tie_home_cats4[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][number]" name="tie_home_cats4[<?php echo $i ?>][number]" value="<?php  if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats4[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][offset]" name="tie_home_cats4[<?php echo $i ?>][offset]" value="<?php  if( !empty($cat['offset']) ) echo $cat['offset']  ?>" type="text" /></label>
									...
									<?php elseif( $cat['type'] == 's' ) : ?>
										...
										<div class="widget-content">
											...
											<label for="tie_home_cats4[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats4[<?php echo $i ?>][title]" name="tie_home_cats4[<?php echo $i ?>][title]" value="<?php  if( !empty($cat['title']) ) echo $cat['title']  ?>" type="text" /></label>
											<label for="tie_home_cats4[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][number]" name="tie_home_cats4[<?php echo $i ?>][number]" value="<?php  if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
											<label for="tie_home_cats4[<?php echo $i ?>][offset]"><span>Offset - number of post to pass over</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][offset]" name="tie_home_cats4[<?php echo $i ?>][offset]" value="<?php  if( !empty($cat['offset']) ) echo $cat['offset']  ?>" type="text" /></label>

											<input id="tie_home_cats4[<?php echo $i ?>][boxid]" name="tie_home_cats4[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
								...
								<?php
									elseif( $cat['type'] == 'rev' ) :	?>
										...
										<div class="widget-content">
											<label for="tie_home_cats4[<?php echo $i ?>][title]"><span>Box Title :</span><input id="tie_home_cats4[<?php echo $i ?>][title]" name="tie_home_cats4[<?php echo $i ?>][title]" value="<?php if( !empty($cat['title']) ) echo $cat['title']  ?>" type="text" /></label>
											<label><span>Box Category 1 : </span><select name="tie_home_cats4[<?php echo $i ?>][id1]" id="tie_home_cats4[<?php echo $i ?>][id1]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id1']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>

											<label><span>Box Category 2 : </span><select name="tie_home_cats4[<?php echo $i ?>][id2]" id="tie_home_cats4[<?php echo $i ?>][id2]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id2']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											
											<label><span>Box Category 3 : </span><select name="tie_home_cats4[<?php echo $i ?>][id3]" id="tie_home_cats4[<?php echo $i ?>][id3]">
												<?php foreach ($categories as $key => $option) { ?>
												<option value="<?php echo $key ?>" <?php if ( $cat['id3']  == $key) { echo ' selected="selected"' ; } ?>><?php echo $option; ?></option>
												<?php } ?>
											</select></label>
											<label><span>Posts Order : </span><select name="tie_home_cats4[<?php echo $i ?>][order]" id="tie_home_cats4[<?php echo $i ?>][order]"><option value="latest" <?php if( $cat['order'] == 'latest' || $cat['order']=='' ) echo 'selected="selected"'; ?>>Latest Reviews</option><option  <?php if( $cat['order'] == 'rand' ) echo 'selected="selected"'; ?> value="rand">Random Reviews</option><option  <?php if( $cat['order'] == 'best' ) echo 'selected="selected"'; ?> value="best">Best Reviews</option></select></label>
											<label for="tie_home_cats4[<?php echo $i ?>][number]"><span>Number of posts to show :</span><input style="width:50px;" id="tie_home_cats4[<?php echo $i ?>][number]" name="tie_home_cats4[<?php echo $i ?>][number]" value="<?php  if( !empty($cat['number']) ) echo $cat['number']  ?>" type="text" /></label>
											<input id="tie_home_cats4[<?php echo $i ?>][boxid]" name="tie_home_cats4[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
									...
									<?php elseif( $cat['type'] == 'ads' ) : ?>
										...
										<div class="widget-content">
											<textarea cols="36" rows="5" name="tie_home_cats4[<?php echo $i ?>][text]" id="tie_home_cats4[<?php echo $i ?>][text]"><?php if( !empty($cat['text']) ) echo stripslashes($cat['text']) ; ?></textarea>
											<input id="tie_home_cats4[<?php echo $i ?>][boxid]" name="tie_home_cats4[<?php echo $i ?>][boxid]" value="<?php  if(empty($cat['boxid'])) echo $cat['type'].'_'.rand(200, 3500); else echo $cat['boxid'];  ?>" type="hidden" />
											<small>Supports <strong>Text, HTML and Shortcodes</strong> .</small>
									<?php endif; ?>
									
									
											<input id="tie_home_cats4[<?php echo $i ?>][type]" name="tie_home_cats4[<?php echo $i ?>][type]" value="<?php  echo $cat['type']  ?>" type="hidden" />
											<a class="del-cat"></a>
				...
				<script>
					...
					<div class="tiepanel-item">	
						...
						<div class="option-item">
							<div style="text-align:center"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/home-builder.png" /></div>
						</div>
					</div>
				</div>	
		...
		<div id="tab6" class="tab_content tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				<?php
					...
					tie_options(
						array(	"name"	=> 'Reading Position Indicator',
				...
				<?php
					...
					tie_options(
						array(	"name" => "Query Type",
								"id" => "related_query",
								"type" => "radio",
								"options"	=> array(	"category"	=> 'Posts in the same Categories',
														"tag"		=> 'Posts in the same Tags',
			...
			<div class="tiepanel-item">
				...
				<h3>Fly Check Also Box</h3>
				<?php
					tie_options(
						array(	"name"	=> 'Check Also Box',
								"id"	=> "check_also",
								"type"	=> "checkbox"));
								
					tie_options(
						array(	"name"		=> 'Check Also Box Position',
		...
		<div id="tab11" class="tab_content tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				<div class="option-item">
					...
					<ul id="sidebar-position-options" class="tie-options">
						...
						<li>
							<input id="tie_sidebar_pos" name="tie_options[sidebar_pos]" type="radio" value="nleft" <?php if($tie_sidebar_pos == 'nleft') echo $checked; ?> />
							<a class="checkbox-select" href="#"><img src="<?php echo get_template_directory_uri(); ?>/panel/images/sidebar-2.png" /></a>
						</li>
						<li>
							<input id="tie_sidebar_pos" name="tie_options[sidebar_pos]" type="radio" value="nright" <?php if($tie_sidebar_pos == 'nright') echo $checked; ?> />
			...
			<div class="tiepanel-item" id="custom-sidebars">
				...
				tie_options(				
					array(	"name" => "Home Sidebar <small><strong>(Blog Layout)</small></strong>",
							"id" => "sidebar_home",
							"type" => "select",
				...
				if(tie_get_option( 'columns_num' ) != '2c'){
					tie_options(				
						array(	"name" => "Home <strong>Narrow</strong> Sidebar <small><strong>(Blog Layout)</small></strong>",
								"id" => "sidebar_narrow_home",
								"type" => "select",
								"options" => $new_sidebars ));
				}	
				...
				if(tie_get_option( 'columns_num' ) != '2c'){
					tie_options(				
						array(	"name" => "Single Page <strong>Narrow</strong> Sidebar",
								"id" => "sidebar_narrow_page",
								"type" => "select",
								"options" => $new_sidebars ));
				}
				...
				if(tie_get_option( 'columns_num' ) != '2c'){			
					tie_options(				
						array(	"name" => "Single Article <strong>Narrow</strong> Sidebar",
								"id" => "sidebar_narrow_post",
								"type" => "select",
								"options" => $new_sidebars ));
				}
				...
				if(tie_get_option( 'columns_num' ) != '2c'){			
					tie_options(				
						array(	"name" => "Archives <strong>Narrow</strong> Sidebar",
								"id" => "sidebar_narrow_archive",
								"type" => "select",
								"options" => $new_sidebars )); 
				}
			...
			if(class_exists( 'bbPress' )){
				...
				if(tie_get_option( 'columns_num' ) != '2c'){			
					tie_options(				
						array(	"name" => "bbPress <strong>Narrow</strong> Sidebar",
								"id" => "sidebar_narrow_bbPress",
								"type" => "select",
								"options" => $new_sidebars )); 
				}
			}
		...
		<div id="tab13" class="tab_content tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				<?php
				tie_options(
					array(	"name" => "Apply Categories Colors on Homepage boxes",
							"id" => "homepage_cats_colors",
							"type" => "checkbox")); 
				
				tie_options(
					array(	"name" => "Use Fade in animation",
							"id" => "lazy_load",
							"type" => "checkbox")); 
				?>
			</div>
